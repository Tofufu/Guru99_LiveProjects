"""
Screenshotting output code for valid user/pw
"""
from selenium.webdriver.common.by import By
import time
from Day6Util import Util
import pandas as pd
...
def ValidLoginVerify(driver, user, pw):
    ...
    if "Guru99 Bank Manager HomePage" not in homepageTitle:
        ...
        if correctManagerString != actualManagerString:
            ...
            totalFile = directory + filename
            try:
                driver.save_screenshot(totalFile)
                print("Screenshot saved: " + str(totalFile))
            except NotADirectoryError:
                print("Not a valid directory")
            except Exception as error:
                print("Other errors: " + str(error))
...
def LoginVerify(driver, url, user, pw):
    try:
        ...
        print("11111111111 Unable to Verify the Output:" + str(error1))
    except Exception as error2:
        print("22222222 Error Logging in: " + str(error2))
    finally:
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Test is done~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
